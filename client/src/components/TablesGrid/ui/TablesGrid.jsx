...
export const TablesGrid = memo(
  ({ tables, highlightedTables, scores, incrementScore, decrementScore, updateScore }) => {
    return (
      <div className="tables-grid">
        {tables.map((tableNumber) => (
          <div key={tableNumber} className="table-container">
            <div
              className={`table ${highlightedTables.includes(tableNumber) ? "highlighted" : ""}`}
            >
              <div className="table-top"></div>
              <div className="table-leg left-leg"></div>
              <div className="table-leg right-leg"></div>
              <span className="table-number">{tableNames[tableNumber].table}</span>
              <span className="table-name">{tableNames[tableNumber].team}</span>
            </div>
